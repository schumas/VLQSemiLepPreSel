...
static const vector<shared_ptr<SelectionItem>> SEL_ITEMS_PRESEL {
    ...
    shared_ptr<SelectionItem>(new SelDatF("leading_jet_pt",    "leading jet p_{T} / 10 GeV",        75, 0, 750       ,100    )),
    shared_ptr<SelectionItem>(new SelDatF("primary_lepton_pt", "primary lepton p_{T} / 10 GeV",     75, 0, 750       ,25     )),
    shared_ptr<SelectionItem>(new SelDatD("ST",                "ST / 25 GeV",                       100, 0, 2500      ,400    )),
